...
class runModel:
    ...
    def run(self):           
        ...
        CNN.train(self.cnn_model, dataloader_train_set, self.CNN_loss_func, self.CNN_optimizer, self.epochs)
        CNN.test_model(self.cnn_model, dataloader_test_set, self.CNN_loss_func)
